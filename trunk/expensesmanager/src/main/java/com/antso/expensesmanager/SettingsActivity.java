...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        ListPreference l = (ListPreference)findPreference("example_list");
        l.setEntries(accountNames.toArray(new String[0]));
        l.setEntryValues(accountIds.toArray(new String[0]));
