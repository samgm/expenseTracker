...
public class RevenuesListFragment extends ListFragment implements HandlingFooterFragment {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        menu.clearHeader();
        menu.add(Constants.REVENUE_TRANSACTION_LIST_CONTEXT_MENU_GROUP_ID, v.getId(), 0,
                getText(R.string.action_transaction_edit));
        menu.add(Constants.REVENUE_TRANSACTION_LIST_CONTEXT_MENU_GROUP_ID, v.getId(), 1,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_transaction_add) {
            Intent intent = new Intent(getActivity().getApplicationContext(), TransactionEntryActivity.class);
            intent.putExtra(IntentParamNames.TRANSACTION_DIRECTION, TransactionDirection.In.getIntValue());
