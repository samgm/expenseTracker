...
//        mItemHeightNormal = 272; //res.getDimensionPixelSize(R.dimen.normal_height);
...
//                    height = mItemHeightNormal;
    ...
    private void startDragging(Bitmap bm, int x, int y) {
        ...
        v.setBackgroundColor(MaterialColours.GREY_300);
//        v.setBackgroundResource(R.drawable.playlist_tile_drag);
    ...
    public void setDropListener(DropListener listener, int itemHeight) {
        mDropListener = listener;

        Resources res = getResources();
        mItemHeightNormal = res.getDimensionPixelSize(itemHeight);
