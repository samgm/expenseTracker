...
public class BudgetManager extends Observable {
    ...
    public class BudgetInfo {
        ...
        public BudgetInfo(Budget budget, Collection<Transaction> transactions) {
            this.budget = budget;
            refresh(DateTime.now(), transactions, true, false);
        }
        ...
        public void addTransaction(Transaction transaction) {
            ...
            if (transaction.getRecurrent() && !transaction.isAutoGenerated()) {
                exploded = TransactionManager.explodeRecurrentTransaction(transaction, DateTime.now());
            }
            exploded.add(transaction);
            refresh(DateTime.now(), exploded, false, false);
        }
        ...
        public void removeTransaction(Transaction transaction) {
            ...
            exploded.add(transaction);
            refresh(DateTime.now(), exploded, false, true);
        }
